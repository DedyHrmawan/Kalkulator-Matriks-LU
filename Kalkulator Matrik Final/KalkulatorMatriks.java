...
public class KalkulatorMatriks {
    ...
    public Component buatTampilan(){
        ...
        //Membuat dan Menambahkan button
		...
		JButton btnDetB = new JButton("|B| ");
                JButton btnDelA = new JButton ("Hapus Matrix A");
                JButton btnDelB = new JButton ("Hapus Matrix B");
                JButton btnDelC = new JButton ("Hapus Hasil");
                JButton btnCls = new JButton ("Hapus Semua" );
		paneBtn.add(btnApB);
		paneBtn.add(btnAmB);
		paneBtn.add(btnAkB);
		paneBtn.add(btnInvA);
		...
		btnApB.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent evt) {
				taA.setText("");
                 ...
                 btnDelB.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				taB.setText("");
			}
		});
                 btnDelC.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent evt) {
				taC.setText("");
			}
		});
        ...
        //pengaturan penyesuaian ukuran matrix panel  
...
//    ----------------------------------------------------
		...
		// == Melakukan pengecekan ukuran matriks kemudian menampilkanya di status bar
